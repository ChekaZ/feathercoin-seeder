...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Trezarcoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed0.Trezarcoin.com", "dnsseed1.Trezarcoin.com", ""};
static const string testnet_seeds[] = {"testnet-dnsseed0.Trezarcoin.com", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 17298), true);
  }
  do {
